...
\fancyhf{}
\rfoot{\rule{14.7em}{0.4pt} \\ Updated March 2016~|~\thepage~of~\pageref{LastPage}}
...
{\sl Senior scientist \& co-founder,} Applied Brain Research
\hfill since February 2016
\begin{itemize} \itemsep -2pt
  \item Researching speech recognition and synthesis
    in spiking neural networks.
  \item Leading development of Nengo software, which includes
    writing code, reviewing and merging contributions,
    and releasing software packages.
